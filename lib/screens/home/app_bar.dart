...
class AppBarWidget extends StatefulWidget {
  ...
  const AppBarWidget(this._height, this._showIcon, this._icon, {Key? key}) : super(key: key);

  @override
  _AppBarWidgetState createState() => _AppBarWidgetState(_height, _showIcon, _icon);
}
