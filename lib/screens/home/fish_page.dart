...
class FishPage extends StatefulWidget {
  ...
  @override
  State<FishPage> createState() => _AquariumsPageState();
}

class _AquariumsPageState extends State<FishPage> {
  ...
  Future<void> _loadData(BuildContext context) async {
    ...
    try {
      ...
      var result = await http.get(Uri.parse(api_endpoint+"api/v1/categories/3"), headers: {
