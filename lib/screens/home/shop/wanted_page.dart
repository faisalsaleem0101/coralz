...
class WantedPostsPage extends StatefulWidget {
  final String title;
  const WantedPostsPage(this.title,{Key? key})
      : super(key: key);

  @override
  State<WantedPostsPage> createState() => _WantedPostsPageState();
}

class _WantedPostsPageState extends State<WantedPostsPage> {
  @override
  WantedPostsPage get widget => super.widget;
          ...
          FloatingActionButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (builder) => PostCreatePage('0', 'Wanted', '6')));
              },
