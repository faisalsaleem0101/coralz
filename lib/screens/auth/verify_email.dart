...
class _VerifyEmailPageState extends State<VerifyEmailPage> {
  ...
  Future<void> _verifyEmail(BuildContext context) async {
    ...
    try {
      ...
      var result = await http.post(Uri.parse(api_endpoint+"api/v1/email/"+otp), headers: {
  ...
  Future<void> _sendEmail(BuildContext context) async {
    ...
    try {
      String? token = await getBearerToken();
      var result = await http.post(Uri.parse(api_endpoint+"api/v1/email"), headers: {
        "Authorization": "Bearer "+token!
      });
  ...
  void initState() {
    ...
    WidgetsBinding.instance
        .addPostFrameCallback((_) => _sendEmail(context));    
  }
